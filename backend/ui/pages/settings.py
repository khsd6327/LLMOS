# ted-os-project/src/tedos/ui/pages/settings.py
"""
Ted OS - 설정 페이지
"""
...
class SettingsPage:
    ...
    def _render_advanced_settings_section(self):
        ...
        provider_status = self.ui.render_provider_status(
            ...
            show_test_buttons=False,  # 설정 페이지에서는 테스트 버튼 숨김
            show_details=True,
            key_suffix="settings_page"
        )

        # 추가 시스템 정보
        with st.expander("기타 시스템 정보", expanded=False):
