...
class OutputRenderer:
        ...
        def improve_code_lang(match):
            ...
            if not lang and code:
                if 'def ' in code or 'import ' in code or 'print(' in code:
                    ...
                    lang = 'javascript'
                elif '<' in code and '>' in code and ('html' in code.lower() or 'div' in code.lower()):
                    lang = 'html'
    ...
    def render_with_metadata(self, text: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """메타데이터와 함께 렌더링"""
        ...
        result = {
            ...
            "has_lists": bool(re.search(r'^\s*[-*+\d]+\.\s+', processed_text, re.MULTILINE)),
